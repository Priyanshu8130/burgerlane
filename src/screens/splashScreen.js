...
class SplashScreen extends Component {
    render() {
        ...
        setTimeout(async() => {
            ...
            onBoardingHandler === 'false' && token ? this.props.navigation.push('BottomTabBar') : onBoardingHandler === 'false' ? this.props.navigation.navigate('Login') : this.props.navigation.navigate('Onboarding');
